...
public final class GuiIngameMenu extends GuiScreen {
	public final void initGui() {
		...
		this.controlList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 48, "Load or Save level.."));
                this.controlList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 72, "Quit Game"));
	...
	protected final void actionPerformed(GuiButton var1) {
		...
		if(this.mc.session != null) {
			...
			if(var1.id == 2) {
                ...
                if(var1.id == 3) {
			this.mc.displayGuiScreen(new GuiMainTitle());
		}
